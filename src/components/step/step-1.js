            ...
            <div className="row">
              <div className="col-md-6">
                <label className="label">
                  Escritório responsável do Ipas *
                </label>
              </div>
              <div className="col-md-6">
              ...
              <div className="col-md-6">
                <div className="wizard-form-input position-relative form-group has-float-label mt-0 n-select-option">
                  <select id="country" name="country" className="form-control">
                    ...
                    <option value="">Hospital Distrital de Nacala Porto</option>
          ...
          <div className="badge-selection">
            ...
            <label className="col-md-12">
              ...
              <span className="checkmark">
                1. Workshop / Treinamento / Orientação
              </span>
            </label>
            <label className="col-md-12">
              <input
                ...
                onChange={handleChange}
              />
              <span className="checkmark">2. Reunião / Colaboração</span>
            </label>
            <label className="col-md-12">
              <input
                type="radio"
              ...
              />
              <span className="checkmark">
                3. Visita de estudo / Visita de intercâmbio
              </span>
            </label>
            <label className="col-md-12">
              <input
                ...
                onChange={handleChange}
              />
              <span className="checkmark">4. Divulgação comunitária</span>
            </label>
            <label className="col-md-12">
              <input
                type="radio"
                ...
                onChange={handleChange}
              />
              <span className="checkmark">5. Pesquisa / Avaliação formal</span>
            </label>
            <label className="col-md-12">
              <input
                type="radio"
                ...
                onChange={handleChange}
              />
              <span className="checkmark">6. Apresentação / Divulgação</span>
            </label>
            <label className="col-md-12">
              <input
                type="radio"
              ...
              />
              <span className="checkmark">
                7. Evento público / Marcha / Comício
              </span>
            </label>
            <label className="col-md-12">
              <input
                ...
                onChange={handleChange}
              />
              <span className="checkmark">8. Mass media</span>
            </label>
            <label className="col-md-12">
              <input
                type="radio"
                ...
                onChange={handleChange}
              />
              <span className="checkmark">9. Outro, especificar</span>
            </label>
          </div>
          <div className="wizard-form-field">
            <div className="wizard-form-input position-relative form-group has-float-label">
            ...
            <div className="row my-3">
              <div className="col-md-6">
                <label>
                  ...
                  <span className="checkbo-box-border"></span>
                  <span className="texable-option">
                    Questões legais / políticas e reforma
                  </span>
                </label>
              </div>
              <div className="col-md-6">
            ...
            <div className="row my-3">
              <div className="col-md-6">
                <label>
                  ...
                  <span className="checkbo-box-border"></span>
                  <span className="texable-option">
                    Violência sexual baseada no gênero
                  </span>
                </label>
              </div>
              <div className="col-md-6">
                <label>
                  ...
                  <span className="checkbo-box-border"></span>
                  <span className="texable-option">
                    Saúde e direitos sexuais e reprodutivos (SRHR)
                  </span>
                </label>
              </div>
            </div>
            <div className="row my-3">
              <div className="col-md-6">
                <label>
                  ...
                  <span className="checkbo-box-border"></span>
                  <span className="texable-option">
                    Padrões e diretrizes para o CAC / PAC
                  </span>
                </label>
              </div>
              <div className="col-md-6">
            ...
            <div className="row my-3">
              ...
              <div className="col-md-6">
                <label>
                  ...
                  <span className="checkbo-box-border"></span>
                  <span className="texable-option">
                    Clarificação de valores e transformação de atitudes (VCAT)
                  </span>
                </label>
              </div>
            </div>
